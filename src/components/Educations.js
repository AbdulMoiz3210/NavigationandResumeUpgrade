...
Webdesigner | Videoeditor | Virtual assistant           
          ...
          <Text style = {styles.aboutme}> My name is AbdulMoiz & i am passionate webdesigner </Text> 
         ...
         <Text onPress={() => Linking.openURL('http://facebook.com/abdulmoiz3210')} style = {{color : '#fff',  fontSize: 20, marginLeft: 25 ,}}>Facebook  |
         <Text onPress={() => Linking.openURL('http://github.com/abdulmoiz3210')} > Github  | </Text> 
        </Text>
